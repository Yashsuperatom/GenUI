...
const Card = ({ title, icon, color, onClick }: CardProps) => (
  ...
  >
    <div className="flex items-center space-x-3 sm:space-x-4">
      <div
        className="flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-md shrink-0"
...
const Hero = ({ onOptionClick }: HeroProps) => {
  ...
  return (
    <div className="flex flex-col min-h-screen px-4 sm:px-6 lg:px-8 pt-25   font-[Inter] bg-white">
      <div className="w-full mx-auto text-center space-y-4 sm:space-y-6 lg:space-y-10 max-w-screen-sm sm:max-w-2xl lg:max-w-4xl">
        {/* Animated Title */}
